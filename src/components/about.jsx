            ...
            <div className='cont'>
                ...
                {/* First about */}
                    <div className='text-about1'>
                        <span className='text-bold'>Научно-производственное<br /> объединение ООО "МОТРАН"</span><br /> - компания, образованная группой инженеров <br />с многолетним опытом работы в области проектирования и изготовления строительно-дорожных машин.<br/><br/> Проект реализуется при поддержке Фонда<br /> содействия развитию малых форм<br /> предприятий в научно-технической сфере. 
                     </div>
